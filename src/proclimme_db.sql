...
insert  into `imagenes`(`id`,`id_producto`,`nombre_archivo`,`descripcion`,`extencion`) values (1,1,'item1.png',NULL,'png'),(2,2,'item2.png','','png'),(3,3,'item3.png','','png'),(4,4,'item4.png','','png'),(5,5,'item5.png','','png'),(6,6,'item6.png','','png'),(7,7,'item7.png','','png'),(8,8,'item8.png',NULL,'png'),(12,20,'item20.jpg','','jpg');
...
insert  into `productos`(`id`,`nombre`,`descripcion_corta`,`descripcion`,`formatos_entrega`,`medio_entrega`,`estatus`,`fecha_creacion`,`ultima_modificacion`,`mostrar_principal`,`orden`) values (1,'PronÃ³stico meteorolÃ³gico a 3 dÃ­as','Pronostico de variables y eventos meteorolÃ³gicos significativos que puedan presentarse dentro de las prÃ³ximas 72 horas','AquÃ­ puede ir una explicaciÃ³n mas larga del producto o se puede reducir la primera.\r\nPronostico de variables y eventos meteorolÃ³gicos significativos que puedan presentarse dentro de las prÃ³ximas 72 horas','1000','4',1,NULL,'2012-08-06',1,1),(2,'PronÃ³stico de FenÃ³menos meteorolÃ³gicos significativos','DeterminaciÃ³n de valores mÃ­nimos de temperatura como sistema de prevenciÃ³n para actividades productivas, pronÃ³stico de lluvias intensas, pronÃ³stico de precipitaciones  que puedan resultar en afectaciones significativas para regiones del territorio mexicano, pronÃ³sticos de ondas gÃ©lidas y de calor, entre otros','DeterminaciÃ³n de valores mÃ­nimos de temperatura como sistema de prevenciÃ³n para actividades productivas, pronÃ³stico de lluvias intensas, pronÃ³stico de precipitaciones  que puedan resultar en afectaciones significativas para regiones del territorio mexicano, pronÃ³sticos de ondas gÃ©lidas y de calor, entre otros.\r\n\r\nDeterminaciÃ³n de valores mÃ­nimos de temperatura como sistema de prevenciÃ³n para actividades productivas, pronÃ³stico de lluvias intensas, pronÃ³stico de precipitaciones  que puedan resultar en afectaciones significativas para regiones del territorio mexicano, pronÃ³sticos de ondas gÃ©lidas y de calor, entre otros','JPG, PNG','Email, sistema proclimme',1,NULL,'2012-08-06',1,2),(3,'PronÃ³stico meteorolÃ³gico a 7 dÃ­as','Pronostico de variables y eventos meteorolÃ³gicos significativos que puedan presentarse dentro de las prÃ³ximas 168 horas, con alta probabilidad de ocurrencia','Pronostico de variables y eventos meteorolÃ³gicos significativos que puedan presentarse dentro de las prÃ³ximas 168 horas, con alta probabilidad de ocurrencia.\r\n\r\nPronostico de variables y eventos meteorolÃ³gicos significativos que puedan presentarse dentro de las prÃ³ximas 168 horas, con alta probabilidad de ocurrencia.','JPG, PNG','Email, sistema proclimme',1,NULL,'2012-08-06',1,3),(4,'Trayectoria y efectos por ciclones tropicales','PronÃ³stico de trayectoria, vientos, rachas y zonas de alertamiento de acuerdo con modelos de pronÃ³stico numÃ©rico e informaciÃ³n emitida por el Centro Nacional de Huracanes de Miami, EU.','PronÃ³stico de trayectoria, vientos, rachas y zonas de alertamiento de acuerdo con modelos de pronÃ³stico numÃ©rico e informaciÃ³n emitida por el Centro Nacional de Huracanes de Miami, EU.\r\n\r\nPronÃ³stico de trayectoria, vientos, rachas y zonas de alertamiento de acuerdo con modelos de pronÃ³stico numÃ©rico e informaciÃ³n emitida por el Centro Nacional de Huracanes de Miami, EU.','JPG, PNG','Email, sistema proclimme',1,NULL,'2012-08-06',1,4),(5,'PronÃ³stico de Marea tormenta','PronÃ³stico de altura de marea asociado con el paso de un ciclÃ³n tropical sobre aguas oceÃ¡nicas que delimitan el territorio mexicano','PronÃ³stico de altura de marea asociado con el paso de un ciclÃ³n tropical sobre aguas oceÃ¡nicas que delimitan el territorio mexicano.','JPG, PNG','Email, sistema proclimme',1,NULL,'2012-08-06',1,5),(6,'PronÃ³stico climatolÃ³gico mensual','PronÃ³stico de precipitaciÃ³n, temperatura y otras variables climatolÃ³gicas para los prÃ³ximos meses enfocadas a determinar las condiciones esperadas con respecto a valores normales','PronÃ³stico de precipitaciÃ³n, temperatura y otras variables climatolÃ³gicas para los prÃ³ximos meses enfocadas a determinar las condiciones esperadas con respecto a valores normales\r\n\r\nPronÃ³stico de precipitaciÃ³n, temperatura y otras variables climatolÃ³gicas para los prÃ³ximos meses enfocadas a determinar las condiciones esperadas con respecto a valores normales','PDF, Word, ImÃ¡gen','CD, Email, Sistema Proclimme',1,NULL,'2012-08-06',1,6),(7,'PronÃ³stico climatolÃ³ico estacional','PronÃ³stico probabilÃ­stico de precipitaciÃ³n, temperatura y otras variables climatolÃ³gicas para 6 o mÃ¡s meses, enfocadas a determinar las condiciones esperadas con respecto a valores normales','PronÃ³stico probabilÃ­stico de precipitaciÃ³n, temperatura y otras variables climatolÃ³gicas para 6 o mÃ¡s meses, enfocadas a determinar las condiciones esperadas con respecto a valores normales\r\n\r\n\r\nPronÃ³stico probabilÃ­stico de precipitaciÃ³n, temperatura y otras variables climatolÃ³gicas para 6 o mÃ¡s meses, enfocadas a determinar las condiciones esperadas con respecto a valores normales','kljkljlj','llkjljlljljlkjklj',1,NULL,'2012-08-01',1,7),(20,'Producto de pruebÃ¡','Esta es una descripciÃ³n de prueba para un producto','Esta es una descripciÃ³n de prueba para un producto','JPG, PNG','Email, sistema proclimme',1,'2012-08-06','2012-08-06',1,8);
